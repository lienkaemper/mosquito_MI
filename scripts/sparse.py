...
neural_noise_strengths = np.linspace(0.001, .2, n_neural)
environmental_noise_strengths = np.linspace(0.001, .2, n_environmental)
...
for trial in range(trials):
    for eta in environmental_noise_strengths:
        sampler, sources_signal, sources_noise = sparse_latent(p_source = p_source, p_sample=p_sample, n_source_signal=n_source_signal, n_source_noise = n_source_noise, n_odorants=n_odorants, concentration_noise=eta, noise_strength = .001)
        ...
        for sigma in neural_noise_strengths:
            ...
            coexp_levels.append(coexp_level(model.w_orn2pn))
            sigma_list.append(sigma)
            eta_list.append(eta)
            with open('../results/sparse_network/w_orn2_pn_trial={}n={:.2f}e={:.2f}'.format(trial,
                                                          sigma, eta), 'wb') as f:
                pkl.dump(model.w_orn2pn, f)
            with open('../results/sparse_network/learning_curve_trial={}n={:.2f}e={:.2f}'.format(trial,
                                                                sigma, eta), 'wb') as f:
            ...
            plt.savefig("../results/plots/sparse/learning_curve={}n={:.2f}e={:.2f}.png".format(trial,
                                                                sigma, eta))
            ...
            axs[0].scatter(val_y, val_y_pred, alpha = .1, color = 'black')
            #axs[0].plot(val_y, val_y, color = "red")
            axs[0].plot(train_y, train_y+.1, color = "red")
            axs[0].plot(train_y, train_y-.1, color = "red")
            axs[0].set_title("validation")

            axs[1].scatter(train_y, train_y_pred, alpha = .1, color = 'black')
            #axs[1].plot(train_y, train_y, color = "red")
            ...
            plt.savefig("../results/plots/sparse/true_vs_pred_trial={}n={:.2f}e={:.2f}.png".format(trial,
                                                                sigma, eta))
            ...
            plt.savefig("../results/plots/sparse/weight_hists_trial={}n={:.2f}e={:.2f}.png".format(trial,
                                                                sigma, eta))
            ...
            plt.savefig("../results/plots/sparse/activation_hists_trial={}n={:.2f}e={:.2f}.png".format(trial,
                                                                sigma, eta))
            ...
            plt.savefig("../results/plots/sparse/expression_trial={}n={:.2f}e={:.2f}.png".format(trial,
                                                                sigma, eta))
...
plt.savefig("../results/plots/sparse/coexp_levels.png")